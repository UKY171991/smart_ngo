...
<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
    <div class="card-header bg-white py-4 px-4">
        <h5 class="fw-bold mb-0">Create New Program</h5>
        <p class="text-muted small mb-0">Add a new program/statistic card to display on the homepage.</p>
    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                           value="{{ old('title') }}" placeholder="e.g., Education Support" required>
                    @error('title')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" 
                           value="{{ old('icon', 'fas fa-heart') }}" placeholder="e.g., fas fa-graduation-cap" required>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror" 
                              placeholder="Describe the program and its impact..." required>{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="statistic_number" class="form-control @error('statistic_number') is-invalid @enderror" 
                           value="{{ old('statistic_number') }}" placeholder="e.g., 500+" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="statistic_label" class="form-control @error('statistic_label') is-invalid @enderror" 
                           value="{{ old('statistic_label') }}" placeholder="e.g., Students Supported" required>
